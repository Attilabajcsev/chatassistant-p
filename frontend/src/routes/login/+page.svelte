...
<div class="relative min-h-screen flex items-center justify-center bg-white p-6 overflow-hidden">
    ...
    <div class="w-full max-w-sm z-10">
        ...
        <h1 class="text-3xl font-semibold text-center mb-8" style:color={purpleColor}>Login</h1>
        ...
        <form method="post" action="?/login" class="space-y-5">
            ...
            <div class="text-right pr-1">
                <a href="/forgot-password" class="text-xs hover:underline" style:color={greenColor}>
                    Forgot password?
                </a>
            </div>
